...
TARGET="dataplane_role_cr/kustomization.yaml"
...
sed -i "s/_FSID_/${FSID}/" dataplane_role_cr/dataplane_v1beta1_openstackdataplane_role.yaml

oc kustomize dataplane_role_cr/
